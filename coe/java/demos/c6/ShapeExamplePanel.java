...
public class ShapeExamplePanel extends JPanel {
	private Ellipse2D.Double circle = new Ellipse2D.Double(10, 10, 200, 200);
	private Rectangle2D.Double square = new Rectangle2D.Double(50, 50, 100, 100);
	...
	public static void main(String[] args) {
		...
		ShapeExamplePanel content = new ShapeExamplePanel();
